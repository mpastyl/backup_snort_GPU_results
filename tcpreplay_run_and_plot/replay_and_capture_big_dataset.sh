...
EOF
		sleep 2
		scp odroid@10.168.1.126:/home/odroid/snort_GPU_system_build/log.txt /Users/mpastyl/snort_GPU_plots/logs_from_snort/result_proper_big_dataset_proper_config_final_$ver"_"$s"_"$i".txt"
	done
	done
done
